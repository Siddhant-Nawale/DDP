...
// ______________________________________________________________
  ...
  return (
    <section className=''>
      ...
      <section id= "section2_1"className='section2_1'>
        <div className='heading '>
          <p className='p1'>
              How We Do It
          </p>
      ...
      <section id="section3" className='section3'>
        ...
        <div id='slidesho2w' className='section1_maindata '>
          ...
          <div className='section3_cover'></div>

          <div className='section3_covertext flex test_borde py-1'>
            <div className='w-flex '>

              <div className='Section3_card_area flex '>
                <div className='Section3_cards  p-5 sm:w-2/6 flex flex-col justify-start items-center whte-glassmorphism section3_box'>
                  <div className=' Section3_card_contents'>
                    <p>
                      Aliquip ea dolore irure ut magna esse aute ut deserunt proident deserunt commodo id aute. Incididunt non deseruntAliquip ea dolore irure ut magna esse aute ut deserunt proident deserunt commodo id aute. Incididunt non deserunt commodo do laborum esse aliquip aliqua aliquip enim Lorem. Elit aliqua esse id id incididunt labore sit cillum mollit nisi duis anim aliqua cupidatat. Enim in nisi ipsum mollit sint. Est commodo ipsum ipsum aliqua et. Dolor sunt aliquip ea ullamco ut ea consequat quis enim sit laborum eiusmod sunt reprehenderit.
                    </p>
                  </div>
                  Lets Go Register
                  <div className=''>
                ...
                <div className='Section3_cards p-5 sm:w-2/6 flex flex-col justify-start items-center whte-glassmorphism section3_box'>
                  <div className=' Section3_card_contents'>
                    <p>
                      Aliquip ea dolore irure ut magna esse aute ut deserunt proident deserunt commodo id aute. Incididunt non deserunt commodo do laborum esse aliquip aliqua aliquip enim Lorem. Elit aliqua esse id iAliquip ea dolore irure ut magna esse aute ut deserunt proident deserunt commodo id aute. Incididunt non deseruntd incididunt labore sit cillum mollit nisi duis anim aliqua cupidatat. Enim in nisi ipsum mollit sint. Est commodo ipsum ipsum aliqua et. Dolor sunt aliquip ea ullamco ut ea consequat quis enim sit laborum eiusmod sunt reprehenderit.
                    </p>
                  </div>
                  Lets Go Login
                  <div className=''>
                    <Link to="/Charity"><button className='navbar_SpecialButton_right_border b1 bg-[#E32952] py-2 pr-4 pl-4  rounded-l-full cursor-pointer hover:bg-[#2546bd] text-white'>Student</button></Link>
                    <Link to="/Charity"><button className='b1 bg-[#E32952] py-2 pr-4 pl-2  rounded-r-full cursor-pointer hover:bg-[#2546bd] text-white'>Donor</button></Link>
                  </div>
                </div>
              </div>
